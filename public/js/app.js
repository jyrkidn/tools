...
window.addEventListener('value-beautified', function (event) {
  editor.setOption('value', event.detail.beautified);
  editor.setOption('mode', event.detail.language);
});

function initEditor() {
  editor = codemirror__WEBPACK_IMPORTED_MODULE_1___default.a.fromTextArea(document.getElementById('editor'), {
    lineNumbers: true,
    matchBrackets: true
  });
...
__webpack_require__(/*! /home/jyrki/web/tools/resources/js/app.js */"./resources/js/app.js");
module.exports = __webpack_require__(/*! /home/jyrki/web/tools/resources/css/app.scss */"./resources/css/app.scss");
